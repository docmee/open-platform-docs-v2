...
- [`POST /api/ppt/portable/createTask`](/api-reference/portable/create-task)
- [`POST /api/ppt/portable/taskResult`](/api-reference/portable/task-result)
...
调用 [`POST https://open.docmee.cn/v2/api/ppt/portable/createTask`](/api-reference/portable/create-task) 创建任务。
...
```text
POST https://open.docmee.cn/v2/api/ppt/portable/taskResult
```
